...
<div class="row">
    ...
    <div class="d-flex flex-column flex-column-fluid align-items-center p-4 reset-password-form">
        <div class="col-12 text-center mt-0">
            <a href="{{ route('home') }}" class="image mb-2 mb-sm-4">
                <img alt="Logo" src="{{ getLogoUrl() }}" class="img-fluid logo-fix-size">
            </a>
            <span class="text-gray-900 fs-1 fw-bold ms-3">{{ getAppName() }}</span>
        </div>
        <div class="width-540">
            @include('layouts.errors')
        </div>
        <div class="bg-white width-540 px-5 px-sm-7 py-10 mx-auto pt-0">
