    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="showAffiliationWithdrawModalBtn">
                    {{ __('messages.affiliation.affiliation_withdraw_detail') }}</h5>
                <button type="button" class="btn-close @if (getLogInUser()->language == 'ar') ms-0 @endif"
            ...
            <div class="modal-body pb-0 pt-2">
                <div>
                    ...
                    <div class="row py-3 paypalEmailDiv d-none">
                        <h5 class="col-4">{{ __('messages.subscription.paypal_email') }} </h5>
                        <div class="col-8">: <span id="PaypalEmail"></span></div>
                    </div>
                    <div class="row py-3 bankDetailsDiv d-none">
                        <h5 class="col-4">{{ __('messages.subscription.bank_details') }} </h5>
                        <div class="col-8">: <span id="viewBankDetails"></span></div>
                    </div>
