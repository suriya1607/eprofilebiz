<div class="modal fade" id="showSubscriptionModal" tabindex="-1" aria-labelledby="showSubscriptionModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('messages.subscription.subscribed_plan_details') }}</h5>
                <button type="button" class="btn-close m-0 @if (getLogInUser()->language == 'ar') m-0 @endif"
