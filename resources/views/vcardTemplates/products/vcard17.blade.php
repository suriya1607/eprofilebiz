        ...
        <div class="main-content mx-auto w-100 overflow-hidden border">
            ...
            <div class="vcard-one__product py-3 mb-10 mt-0">
                <div class="row justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="col-4">
                        <h4 class="vcard-seventeen-heading p-1 ms-3" style="font-size:26px">
                            {{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 text-center mt-2">
                        <a class="vcard-seventeen-btn text-white text-decoration-none"
                            href="{{ $vcardUrl }}"
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card border w-75 h-100">
                                        <div class="product-profile {{ $product->media->count() < 2 ? 'd-flex justify-content-center dots-none' : '' }} mt-1 product-img-slider overflow-hidden">
                                            @foreach ($product->media as $media)
                                            <div>
                                                <div class="product-img-height h-100 text-center mt-4 p-2 w-100 mx-auto">
