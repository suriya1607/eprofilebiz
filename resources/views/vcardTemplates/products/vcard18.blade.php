    ...
    <div class="container p-0 product-details-page">
        <div class="vcard-eighteen main-content mx-auto w-100 overflow-hidden">
            ...
            <div class="vcard-one__product py-3 mb-10 mt-0">
               <div class="px-40">
                <div class="row justify-content-between align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="col-4">
                        <h4 class="vcard-prodcut-heading fw-500 fs-1 p-2 text-primary">
                            {{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 mt-20 text-center">
                        <a class="vcard-eighteen-btn text-white bg-primary text-decoration-none d-block ms-auto"
                            href="{{ $vcardUrl }}"
                        ...
                        @foreach ($products as $product)
                            <div class="d-flex justify-content-center mb-2">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card border w-100 h-100">
                                        ...
                                        <div class="bg-primary-light card-body p-0">
