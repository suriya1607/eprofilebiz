            ...
            <div class="vcard-two__product_details_page py-3 mt-0">
                <div class="row justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="col-4 mt-6 text-center ">
                        <a class="product-btn text-white rounded-2 text-decoration-none"
                            href="{{ $vcardUrl }}"
                            ...
                            <div class="my-2   d-flex justify-content-center">
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card p-2 border-0 w-75 h-100">
                                        <div class="{{ $product->media->count() < 2 ? 'd-flex justify-content-center' : '' }} object-fit-contain product-img-slider overflow-hidden">
