            ...
            <div class="vcard-three__product_details_page py-3 mb-10 mt-0">
                <div class="row justify-content-between" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="col-4 mt-6 text-center">
                        <a class="vcard-three-btn text-white text-decoration-none"
                            href="{{ $vcardUrl }}"
                                    ...
                                    <div class="card product-card p-2 border-0 w-75 h-100">
                                        ...
                                        <div class="product-details mt-3">
                                            ...
                                            @if ($product->currency_id && $product->price)
                                                <span
                                                    class="text-white product-price-{{ $product->id }}">{{ $product->currency->currency_icon }}{{ getSuperAdminSettingValue('hide_decimal_values') == 1 ? number_format($product->price, 0) : number_format($product->price, 2) }}</span>
                                            @elseif($product->price)
                                                <span
                                                    class="text-white product-price-{{ $product->id }}">{{ getUserCurrencyIcon($vcard->user->id) }}{{ $product->price }}</span>
                                            @endif
                                </a>
