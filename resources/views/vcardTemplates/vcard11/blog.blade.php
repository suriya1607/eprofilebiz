                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            @foreach ($vcard->blogs->reverse() as $blog)
                                <?php
                                $vcardBlogUrl = $isCustomDomainUse ? "https://{$customDomain->domain}/{$vcard->url_alias}/blog-single/{$blog->id}" : route('vcard.show.blog-single', ['alias' => $vcard->url_alias, 'id' => $blog->id]);
                                ?>
