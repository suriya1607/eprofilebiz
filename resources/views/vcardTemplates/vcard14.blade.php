    ...
    <div class="container p-0">
        ...
        <div
            ...
            <div class="main-section pt-30 pb-30 px-30 position-relative">
                ...
                <div class="text-black fs-14 text-center profile-desc">
            ...
            <div class="contact-section main-section pt-30 pb-30 px-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.contact_us.contact') }}</h2>
                </div>
                @if (getLanguage($vcard->default_language) != 'Arabic')
            ...
            <div class="gallery-section main-section pt-30 pb-30 position-relative">
                ...
                <div class="section-heading px-30">
                    <h2 class="text-black mb-0">{{ __('messages.plan.gallery') }}</h2>
                </div>
                <div class="px-40">
            ...
            <div class="our-services-section main-section pt-30 pb-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.vcard.our_service') }}</h2>
                </div>
                <div class="services">
                                ...
                                <div class="col-sm-6">
                                    <div class="service-card d-flex flex-column h-100" @if (getLanguage($vcard->
                                        ...
                                        <div class="card-body pt-3 px-0 pb-0 text-center">
                                            ...
                                            <p class="mb-0 text-gray-100 description-text">
            ...
            <div class="qr-code-section main-section pt-30 pb-30  px-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.vcard.qr_code') }}</h2>
                </div>
            ...
            <div class="product-section main-section pt-30 pb-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.plan.products') }}</h2>
                </div>
                <div class="px-20">
                                    ...
                                    <div class="product-desc card-body">
                                        <div class="d-flex justify-content-center align-items-center flex-column">
                                            ...
                                            <div class="product-amount">
                                                ...
                                                <span class="product-amount">{{ $product->currency->currency_icon }}{{
                                                    getSuperAdminSettingValue('hide_decimal_values') == 1 ?
                                                    number_format($product->price, 0) : number_format($product->price,
                                                    2) }}</span>
                                                @elseif($product->price)
                                                <span class="product-amount">{{ getUserCurrencyIcon($vcard->user->id) .
                                                    ' ' . $product->price }}</span>
                                                @endif
            ...
            <div class="testimonial-section main-section pt-30 pb-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.plan.testimonials') }}</h2>
                </div>
                <div class="px-20">
            ...
            <div class="appointment-section main-section pt-30 pb-30 px-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.make_appointments') }}</h2>
                </div>
            ...
            <div class="main-section pt-30 pb-30 position-relative">
                ...
                <div class="insta-feed">
                    <div class="section-heading">
                        <h2 class="text-black mb-0">{{ __('messages.feature.insta_embed') }}
                        </h2>
                    </div>
                </div>
                <nav class="px-30">
            ...
            <div class="blog-section main-section pt-30 pb-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.feature.blog') }}</h2>
                </div>
                    ...
                    <div>
                        <div class="blog-card">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between text-start">
                                <h5 class="text-dark fs-20 mb-2"> {{ $blog->title }}</h5>
                                <div class="text-gray-100 blog-desc mb-1">
                                    {!! $blog->description !!}
                                </div>
                                <div class="text-end @if (getLanguage($vcard->
                                    default_language) ==
                                    'Arabic') ms-0 @else ms-auto @endif" >
                                    <a href="{{ $vcardBlogUrl  }}" class="text-primary d-inline-block fs-16">
                                        Read More...
                                    </a>
                                </div>
                            </div>
            ...
            <div class="bussiness-hour-section main-section px-30 pt-30 pb-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.business.business_hours') }}
                    </h2>
                </div>
                <div class="position-relative">
            ...
            <div class="contact-us-section main-section px-30 pt-30 pb-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.contact_us.inquries') }}</h2>
                </div>
                @if (getLanguage($vcard->default_language) != 'Arabic')
            ...
            <div class="create-vcard-section main-section px-30 pt-30 pb-30 position-relative">
                ...
                <div class="section-heading">
                    <h2 class="text-black mb-0">{{ __('messages.create_vcard') }}</h2>
                </div>
                <div class="vcard-link-card card">
                    <div class="d-flex align-items-center justify-content-center gap-3" @if (getLanguage($vcard->
                        ...
                        <a href="{{ route('register', ['referral-code' => $vcard->user->affiliate_code]) }}"
                            class="text-primary-200 link-text" target="_blank">{{ route('register', ['referral-code'
                            => $vcard->user->affiliate_code]) }}
                        </a>
                        <i class="icon fa-solid fa-arrow-up-right-from-square share-icon text-primary-200"></i>
                    </div>
                </div>
            </div>
            @endif
                        ...
                        <div
                            ...
                            <div class="{{ isset($vcard->whatsapp_share) ? 'vcard14-btn-group' : 'stickyIcon' }}">
                                <a type="button" class="social-btn event-sub-btn mb-3 px-2 py-1  vcard14-share"><i
                                        class="fas fa-share-alt fs-4 text-primary"></i></a>
                                ...
                                {{-- <a type="button"
                                    ...
                                    id="videobtn"><i class="fa-solid fa-video fs-4 text-primary"></i></a>
                                --}}
                            </div>
                            @endif
                        </div>
            ...
            <div class="d-flex justify-content-evenly main-section pt-3 pb-3 flex-wrap flex-sm-nowrap">
                ...
                @else
                <div class="text-center">
                    <span class="text-black fw-5 fs-14">{{ __('messages.made_by') }}
