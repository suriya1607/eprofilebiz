    ...
    <div class="container p-0">
        ...
        <div
            ...
            <div class="insta-section pt-50 position-relative">
                                ...
                                <div
                                    ...
                                    <div class="text-sm-start text-center">
                                        ...
                                        <p class="fs-14 text-gray mb-0">
                                            Point your phone’s camera at the QR code to quickly add our contact
                                            information. You
                        ...
                        <form action="" id="enquiryForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button class="contact-btn send-btn btn-primary" type="submit" {{$subscriptionclass}}>
                        ...
                        <form action="" id="enquiryForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-center mt-4 mb-2">
                                    <button class="contact-btn send-btn btn-primary w-50" type="submit" {{$subscriptionclass}}>
                                        {{ __('messages.contact_us.send_message') }}
                                    </button>
                                </div>
                            </div>
                ...
                <div class="add-to-contact-section px-30 text-center" @if($subscriptionclass == 'disabled') style="pointer-events:none;opacity:0.5;"@endif>
