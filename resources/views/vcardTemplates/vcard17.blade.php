        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                            ...
                            <div class="row">
                                @if ($vcard->email)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-wrapper mb-2 bg-pink">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center bg-pink mb-2">
                                                <img src="{{ asset('assets/img/vcard17/email.png') }}" class="w-100"/>
                                            </div>
                                ...
                                @if ($vcard->phone)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-wrapper mb-2 bg-orange">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center bg-orange mb-2">
                                                <img src="{{ asset('assets/img/vcard17/phone.png') }}" class="w-100"/>
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-wrapper mb-2 bg-blue">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center bg-blue mb-2">
                                                <img src="{{ asset('assets/img/vcard17/dob-icon.png') }}" class="w-100"/>
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-wrapper mb-2 bg-purple">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-center bg-purple mb-2">
                                                <img src="{{ asset('assets/img/vcard17/location.png') }}" class="w-100"/>
                                            </div>
                                            <div class="contact-desc">
                                        ...
                                        <div class="col-sm-6 mb-40">
                                            <div class="service-card d-flex flex-column align-items-center gap-2"
                                                ...
                                                <div class="card-body p-0">
                                                    ...
                                                    <p
                                                        class="mb-0 text-gray-300 text-center {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <button class="btn send-btn contact-btn rounded-2 btn-primary" type="submit" {{$subscriptionclass}}>
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section px-30">
                    <div class="text-center mb-2" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif @if($subscriptionclass == 'disabled') style="pointer-events:none;opacity:0.5;"@endif>
                        @if ($contactRequest == 1)
