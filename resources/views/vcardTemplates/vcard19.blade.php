                            ...
                            <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->email }}" class="text-primary fs-14 fw-5">{{
                                                    $vcard->email }}</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if ($vcard->alternative_email)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-start">
                                                <img src="{{ asset('assets/img/vcard19/email-icon.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->alternative_email }}" class="text-primary fs-14 fw-5">{{
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-sm-0 mb-40">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-start">
                                                <img src="{{ asset('assets/img/vcard19/dob-icon.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6">
                                        <div class="contact-box">
                                            <div
                                                class="contact-icon d-flex justify-content-center align-items-start">
                                                <img src="{{ asset('assets/img/vcard19/vector.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="contact-desc">
                                ...
                                @if ($vcard->alternative_email)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            ...
                                            <div class="contact-desc">
                                                <a href="mailto:{{ $vcard->alternative_email }}" class="text-primary fs-12 fw-5">{{
                                        $vcard->alternative_email }}</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="business-hour mb-2 overflow-hidden">
                                <div class="row justify-content-between m-0">
                                    ...
                                    <div class="col-8 py-2 text-primary fs-16">
                                        <span class="d-flex gap-2 align-items-center"><i class="fa-regular fa-clock"></i>{{ $dayTime ?? __('messages.common.closed') }}</span>
                                        </div>
                                </div>
                                </div>
                            @endforeach
