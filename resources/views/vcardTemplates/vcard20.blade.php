...
<body>
    <div class="container p-0">
        ...
        <div
            ...
            <div class="profile-section px-30 pb-40 position-relative bg-white">
                <div class="position-absolute w-100 start-0 top-0">
                    <img src={{ asset ("assets/img/vcard20/theme-bg-main.png") }} alt="images" class="w-100" />
                    </div>
                <div class="card flex-sm-row align-items-center gap-4 pt-4">
                    ...
                    <div class="card-body pt-sm-0 px-0 text-sm-start text-center">
                        <div class="profile-name">
                            ...
                            <p class="fs-16 text-gray-100 fw-5 mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-16 text-gray-100 fw-5 mb-0">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
                ...
                {{-- social icon --}}
                    ...
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                                    <div class="social-media pt-40 d-flex flex-wrap justify-content-center">
                        <div
            ...
            <div class="contact-section position-relative px-30 pt-40 pb-5">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section px-30 pt-40 pb-4">
                        ...
                        <div class="section-heading text-center mb-40 overflow-hidden">
                            <h2 class="text-black mb-1 d-inline-block">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-40 px-30 pb-4">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pt-40 px-4 position-relative">
                        <div class="position-absolute vector-all vector-1">
                            <img src="{{ asset ('assets/img/vcard20/veg-vector-1.png') }}" alt="images" class="w-100" />
                            </div>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-40 px-30 pb-40">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-feed-main pt-40 pb-5">
                        <div class="px-30">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-40 pb-40 px-30 position-relative">
                        <div class="position-absolute vector-all vector-2">
                            <img src="{{ asset ('assets/img/vcard20/veg-vector-2.png') }}" alt="images" class="w-100" />
                            </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-40 px-30 position-relative">
                    <div class="position-absolute vector-all vector-4">
                            <img src="{{ asset ('assets/img/vcard20/veg-vector-3.png') }}" alt="images" class="w-100" />
                            </div>
                    <div class="qr-code-bg-img">
                        <img src="{{ asset('assets/img/vcard20/veg-vector-4.png') }}" loading="lazy" />
                    </div>
                    <div class="section-heading text-center mb-40 overflow-hidden">
                        <h2 class="text-black mb-1 d-inline-block">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-40 pb-5 px-30">
                        <div class="section-heading text-center mb-40 overflow-hidden">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-40 pb-40 px-30">
                    ...
                    <div class="position-absolute vector-all vector-5">
                            <img src="{{ asset ('assets/img/vcard20/veg-vector-5.png') }}" alt="images" class="w-100" />
                            </div>
                    <div class="section-heading text-center overflow-hidden mb-40">
                        <h2 class="text-black mb-1 d-inline-block">
                        ...
                        <div class="contact-form pt-3 mt-3 position-relative">
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @endif
                                    <div class="col-12 text-center">
                                        <button class="contact-btn send-btn btn-primary btn p-0" type="submit"{{$subscriptionclass}}>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-40 pb-40 px-30 mb-5">
            ...
            @if ((isset($managesection) && $managesection['map']) || empty($managesection))
                ...
                @if ($vcard->location_type == 1 && !empty($vcard->location_embed_tag))
                    <div class="px-30">
                        <div class="embed-responsive embed-responsive-16by9 rounded overflow-hidden map-iframe-section"
                            style="height: 300px;">
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section z-index-9" @if($subscriptionclass == 'disabled') style="pointer-events:none;opacity:0.5;"@endif>
