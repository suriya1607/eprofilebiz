        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-img @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-40 @if($vcard->cover_type == 2) profile-margin @endif">
                <div class="card flex-column align-items-end justify-content-sm-start">
                    <div class="w-100">
                        <div class="card-img d-flex justify-content-center align-items-center position-relative ms-auto @if($vcard->cover_type == 2) profile-margin-top @endif">
                        <div class="position-absolute vector-1 vector-all">
                            <img src="{{ asset ('assets/img/vcard21/vector-1.png') }}" alt="images" class="w-100"/>
                        </div>
                        <div class="position-absolute vector-2 vector-all text-end">
                            <img src="{{ asset ('assets/img/vcard21/vector-2.png') }}" alt="images" class="w-100"/>
                        </div>
                        <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover main-img" loading="lazy" />
                    </div>
                    </div>
                    <div class="card-body p-0 text-sm-start text-center @if($vcard->cover_type == 2) profile-des @endif">
                ...
                <div class="social-media pt-30 d-flex flex-wrap justify-content-sm-start justify-content-center position-relative">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30">
                        <div class="position-absolute vector-3 vector-all text-end">
                            <img src="{{ asset ('assets/img/vcard21/vector-3.png') }}" alt="images" class="w-100"/>
                        </div>
                        <div class="position-absolute vector-4 vector-all">
                            <img src="{{ asset ('assets/img/vcard21/vector-4.png') }}" alt="images" class="w-100"/>
                        </div>
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-3 position-relative">
                        <div class="position-absolute vector-5 vector-all">
                            <img src="{{ asset ('assets/img/vcard21/vector-5.png') }}" alt="images" class="w-100"/>
                        </div>
                        <div class="position-absolute vector-6 vector-all text-end">
                            <img src="{{ asset ('assets/img/vcard21/vector-6.png') }}" alt="images" class="w-100"/>
                        </div>
                            ...
                            <div class="business-hour-card row justify-content-center">
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-md-6 mb-3">
                                        <div class="business-hour d-flex flex-column justify-content-center align-items-center gap-2">
                                            <div
                                                class="">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                                :</div>
                                            <div class="d-flex align-items-center justify-content-center gap-2">
                                                <i class="fa-regular fa-clock text-primary"></i>
                                                <div class="text-primary">{{ $dayTime ?? __('messages.common.closed') }}</div>
                                                </div>
                                        </div>
                                    </div>
                                @endforeach
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-40 position-relative">
                    <div class="position-absolute vector-7 vector-all text-end">
                            <img src="{{ asset ('assets/img/vcard21/vector-7.png') }}" alt="images" class="w-100"/>
                        </div>
                    <div class="qr-bg-img">
