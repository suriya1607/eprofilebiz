                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="contact-desc fw-5" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                class="contact-desc fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
