    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-30">
                <div class="card gap-2 d-flex flex-sm-row align-items-sm-end align-items-center pb-40">
                    <div class="card-img">
                    ...
                    <div class="card-body text-sm-start text-center pt-30">
                        <div class="profile-name pt-60">
                            <h2 class="text-secondary mb-0 fs-24 fw-6">
                                {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                @if ($vcard->is_verified)
                                    <i class="verification-icon bi-patch-check-fill"></i>
                                @endif
                            </h2>
                            <p class="fs-16 text-primary dashed-underline mb-0">{{ ucwords($vcard->company) }}</p>
                ...
                <div class="custom-link-section">
                    @if (checkFeature('custom-links'))
                        <div class="custom-link d-flex flex-wrap justify-content-center py-4 w-100 ">
                ...
                <div class="desc pb-40 text-center">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section px-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="row">
                        @if ($vcard->email)
                            <div class="col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="contact-desc text-center">
                                        <a href="mailto:{{ $vcard->email }}"
                                            class="text-secondary fs-14 fw-5 text-center">{{ $vcard->email }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="contact-box">
                                    ...
                                    <div class="contact-desc text-center">
                                        <a href="mailto:{{ $vcard->alternative_email }}"
                                            class="text-secondary fs-14 fw-5 text-center">{{ $vcard->alternative_email }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="contact-box">
                                    ...
                                    <div class="contact-desc text-center">
                                        <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                            class="text-secondary fs-14 fw-5 text-center" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                ...
                                <div class="contact-box">
                                    ...
                                    <div class="contact-desc text-center">
                                        <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                            class="text-secondary fs-14 fw-5 text-center" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                        @if ($vcard->dob)
                            <div class="col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="contact-desc text-center">
                                        <p class="mb-0 text-secondary fs-14 fw-5 text-center"> {{ $vcard->dob }}</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        @if ($vcard->location)
                            <div class="col-sm-6">
                                <div class="contact-box">
                                    ...
                                    <div class="contact-desc text-center">
                                        <p class="text-secondary mb-0 fs-14 fw-5 text-center">{!! ucwords($vcard->location) !!}</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30">
                        ...
                        <div class="appointment">
                                ...
                                <div class="text-center px-sm-5 px-2">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60 px-30 pb-30 mb-4">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pb-60">
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section mt-2 pb-4 pt-60 px-sm-3">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section px-30 mb-3">
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="business-hours bg-white" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            ...
                            <div class="wrapper mb-3">
                                <div class="hours d-flex align-items-center gap-2 justify-content-between">
                                    <span
                                        class="days d-flex align-items-center gap-1">
                                      <div class="icon-calendar">
                                        <svg  xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#f96921" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-clock"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M10.5 21h-4.5a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v3"></path> <path d="M16 3v4"></path> <path d="M8 3v4"></path> <path d="M4 11h10"></path> <path d="M18 18m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0"></path> <path d="M18 16.5v1.5l.5 .5"></path>
                                        </svg>
                                        </div>
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section pt-60 pb-60 px-sm-3">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section px-30 pb-60">
                    <div class="section-heading text-center mb-40">
                            ...
                            <form action="" id="enquiryForm" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-center mt-2">
                                        <button class="contact-btn send-btn btn btn-primary" type="submit" {{$subscriptionclass}}>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="pt-40 pb-40 px-30 pt-0">
                    <div class="bg-img">
                        <img src="{{ asset('assets/img/vcard23/bg-img.png') }}" loading="lazy" />
                    </div>
                </div>
                <div class="create-vcard-section pt-60 pb-60 px-30 mb-4">
                    <div class="section-heading text-center mb-40">
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section mb-2" @if($subscriptionclass == 'disabled') style="pointer-events:none;opacity:0.5;"@endif>
