    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section pt-60 pb-60 px-30 @if($vcard->cover_type == 2) mt-5 pt-0 @endif">
                ...
                <div class="card d-flex flex-sm-row flex-column gap-3 align-items-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="card-img">
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="text-black fw-5" dir="ltr">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}"
                                                class="text-black fw-5" dir="ltr">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="">
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body p-0">
                                            <h2 class="fs-6 fw-6 text-black blog-head text-center">{{ $blog->title }}
                                            </h2>
                                        </div>
                                    </div>
                                </div>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-30">
                        ...
                        <div class="">
                            <div class="business-hours row justify-content-center row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                @foreach ($businessDaysTime as $key => $dayTime)
                               <div class="col-sm-6">
                                <div class="d-flex justify-content-center align-items-center business-box flex-column">
                                        <div>{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ':' }}</div>
