...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            {{-- profile detials --}}
            <div class="profile-section px-30 position-relative"
                @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                <div class="position-absolute vector-all vector-1 text-end">
                        <img src="{{ asset('assets/img/vcard25/vector-1.png') }}" alt="imgaes" class="w-100"/>
                    </div>
                <div class="profile-bg-img">
                    <img src="{{ asset('assets/img/vcard25/profile-bg-img.png') }}" loading="lazy" />
                </div>
                <div class="card d-flex flex-sm-row  align-items-center position-relative profile-margin my-4 gap-4"
                    @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="card-img">
                    ...
                    <div class="card-body text-sm-start text-center mt-sm-0 pt-sm-0 p-0">
                        <div class="profile-name">
                            <h2 class="text-secondary mb-1 mt-0 mt-sm-2 fs-28 fw-5">
                ...
                <div class="text-gray-100 profile-desc mb-sm-0 fs-14 text-center">
                    {!! $vcard->description !!}</div>
                {{-- social icons --}}
                @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media d-flex justify-content-center flex-wrap mb-3">
                        <div
                            class="social-icons position-relative d-flex justify-content-center text-decoration-none flex-wrap text-primary bg-gray-100 rounded-pill">
                            <div class="position-absolute vector-all vector-2">
                        <img src="{{ asset('assets/img/vcard25/vector-2.png') }}" alt="imgaes" class="w-100"/>
                    </div>
                            ...
                            @if ($vcard->dob)
                                <div class="col-sm-6">
                                    <div class="contact-box text-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center mx-auto">
                                            <img src="{{ asset('assets/img/vcard25/dob-icon.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                                            <p class="text-secondary fs-6 fw-5 mb-0">{{ $vcard->dob }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            @if ($vcard->location)
                                <div class="col-sm-6">
                                    <div class="contact-box text-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center mx-auto">
                                            <img src="{{ asset('assets/img/vcard25/location.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
                                            <p class="text-secondary fs-6 fw-5 mb-0">{!! ucwords($vcard->location) !!}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 px-30 position-relative mb-0 position-relative">
                        <div class="position-absolute vector-all vector-3 text-end">
                        <img src="{{ asset('assets/img/vcard25/vector-3.png') }}" alt="imgaes" class="w-100"/>
                    </div>
                        <div class="gallery-bg-img">
                            <img src="{{ asset('assets/img/vcard25/gallery-bg.png') }}" alt="gallery-bg"
                                loading="lazy" />
                        </div>
                ...
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-60">
                        <div class="services-bg-img">
                            <img src="{{ asset('assets/img/vcard25/services-bg.png') }}" alt="services-bg-img"
                                loading="lazy" />
                        </div>
                                    ...
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6 mb-sm-4 mb-4">
                                            <div class="service-card h-100">
                                                ...
                                                <div class="card-body text-center p-0 flex-grow-0">
                ...
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-30">
                        <div class="product-bg-img text-end">
                            <img src="{{ asset('assets/img/vcard25/product-bg.png') }}" alt="product-bg-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="">
                           ...
                           <div class="text-center">
                            <div class="mt-2 text-center view-more d-inline-flex gap-2 align-items-center">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-60 px-30 position-relative">
                        <div class="position-absolute vector-all vector-4 text-end">
                        <img src="{{ asset('assets/img/vcard25/vector-4.png') }}" alt="imgaes" class="w-100"/>
                    </div>
                        <div class="section-heading text-center mb-40">
                        ...
                        <div class="appointment">
                            <div class="row">
                                ...
                                <div class="col-sm-11 mb-20 mx-auto">
                            ...
                            <div class="row">
                                <div class="col-sm-11 mx-auto">
                                    ...
                                    <div class="mt-3 appointment-btn mx-auto">
                                            ...
                                            <div class="">
                                                <div class="quote-img text-center mb-3">
                                                    <img src="{{ asset('assets/img/vcard25/quote-img.png') }}"
                                                        alt="quote-img" class="ms-auto me-3" loading="lazy" />
                                                </div>
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    ...
                    <div id="postContent" class="insta-feed">
                        <div class="row overflow-hidden m-0 mt-2 px-2">
                            <!-- "Post" content -->
                ...
                <div class="qr-code-section pt-60 px-40">
                    ...
                    <div class="qr-code mx-auto position-relative">
                        <div class="qr-bg-img text-end">
                            <img src="{{ asset('assets/img/vcard25/qr-code-bg.png') }}" alt="qr-bg-img"
                                loading="lazy" />
                        </div>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-40 position-relative">
                        ...
                        <img src="{{ asset('assets/img/vcard25/vector-5.png') }}" alt="imgaes" class="w-100"/>
                    </div>
                    <div class="position-absolute vector-all vector-6 text-end">
                        <img src="{{ asset('assets/img/vcard25/vector-6.png') }}" alt="imgaes" class="w-100"/>
                    </div>
                        <div class="business-hour-bg">
                            <img src="{{ asset('assets/img/vcard25/business-hour-bg.png') }}" alt="bg-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                            <h2 class="mb-0">{{ __('messages.business.business_hours') }}</h2>
                        </div>
                        <div class="business-hours d-flex flex-column" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <div class="business-hour-vector1">
                                <img src="{{ asset('assets/img/vcard25/business-hour-vector.png') }}" alt="vector"
                                    loading="lazy" />
                            </div>
                            ...
                            @foreach ($businessDaysTime as $key => $dayTime)
                                <div class="d-flex justify-content-between flex-wrap flex-sm-nowrap">
                                    <div class="days w-50">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}:</div>
                                   <div class="d-flex gap-2 align-items-center time w-50">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-100">
                    <div class="create-vcard-img1">
                        <img src="{{ asset('assets/img/vcard25/create-vcard-img1.png') }}" alt="create-vcard-img"
                            loading="lazy" />
                    </div>
                    <div class="create-vcard-img2 text-end">
                        <img src="{{ asset('assets/img/vcard25/create-vcard-img2.png') }}" alt="create-vcard-img"
                            loading="lazy" />
                    </div>
