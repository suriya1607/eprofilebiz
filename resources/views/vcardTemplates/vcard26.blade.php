    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-30">
                ...
                <div class="card d-flex align-items-center justify-content-center mb-3 @if($vcard->cover_type == 2) profile-margin @endif">
                    <div class="card-img">
                            ...
                            @if ($vcard->location)
                                <div class="col-sm-6">
                                    <div class="contact-box d-flex align-items-center">
                                        <div
                                            class="contact-icon d-flex justify-content-center align-items-center me-2">
                                            <img src="{{ asset('assets/img/vcard26/location.png') }}"
                                                loading="lazy" />
                                        </div>
                                        <div class="contact-desc">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-30 px-30 mb-5 pb-3">
                        <div class="cards-img">
                            <img src="{{ asset('assets/img/vcard26/cards.png') }}" alt="cards-img"
                                loading="lazy" />
                        </div>
                        <div class="section-heading text-center mb-40">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section px-10 pb-5 position-relative">
                        <div class="position-absolute vector-all vector-2">
                            <img src="{{ asset("assets/img/vcard26/vector-1.png") }}" alt="images" class="w-100"/>
                        </div>
                        ...
                        <div class="business-hours row justify-content-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex justify-content-between flex-column business-box">
                                    <div class="fs-14 text-primary">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                        :</div>
                                  <div class="d-flex align-items-center gap-2 fs-14 justify-content-center">
                                    <i class="fa-regular fa-clock text-white"></i>
                                    <div class="text-white">{{ $dayTime ?? __('messages.common.closed') }}</div>
                                    </div>
                                </div>
                            </div>
                            @endforeach
