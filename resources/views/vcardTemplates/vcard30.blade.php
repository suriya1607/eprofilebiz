                ...
                @if (getLanguage($vcard->default_language) != 'Arabic')
                    <div class="card d-flex align-items-sm-stretch align-items-center mb-20">
                        ...
                        <div class="card-body p-0 text-sm-start text-center">
                            <div class="profile-name mb-3 @if ($vcard->cover_type == 2) profile-min-height @endif">
            ...
            <div class="contact-section pt-60 px-40">
                ...
                <div class="row row-gap-20px" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    @if ($vcard->email)
                        <div class="col-sm-6">
                            <div
                                class="contact-box d-flex flex-sm-column flex-row align-items-center gap-2">
                    ...
                    <div class="product-section pt-60 px-40">
                        ...
                        <div class="product-slider">
                            @foreach ($vcard->products as $product)
                                <div class="">
                                    <div class="card-wrapper">
                                        <div class="product-card card flex-row justify-content-between align-items-center gap-4"
                        ...
                        <div class="text-center">
                            <div class="mt-3 text-center btn-primary view-more mb-5 d-inline-flex justify-content-center align-items-center gap-2 mx-auto">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-40">
                        ...
                        <div
                            class="business-hour-card row justify-content-center"@if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            @foreach ($businessDaysTime as $key => $dayTime)
                                <div class="col-sm-6 mb-3 pe-sm-2">
                                    <div class="business-hour">
                                        <div class="line"></div>
                                        <div>{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                            :</div>
