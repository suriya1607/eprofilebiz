...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            {{-- profile section --}}
            <div class="profile-section px-30 mb-1 position-relative @if($vcard->cover_type == 2) profile-margin @endif" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif >
                <div class="position-absolute vector-all vector-1 text-end">
                    <img src="{{ asset ("assets/img/vcard31/vector-1.png") }}" alt="images" class="w-100" />
                </div>
                <div class="profile-bg-img text-sm-start text-end">
                    <img src="{{ asset('assets/img/vcard31/profile-bg-img.png') }}" loading="lazy"
                        alt="profile-bg" />
                </div>
                <div class="card d-flex">
                <div class="w-100">
                    <div class="card-img ms-auto position-relative">
                    ...
                    <div class="card-body bg-light">
                        <div class="profile-name text-center text-sm-start">
                            ...
                            <p class="text-primary mb-1 fs-16 company-name d-inline-block">{{ ucwords($vcard->company) }}</p>
                            <p class="text-gray-100 fs-14 mb-0">{{ ucwords($vcard->occupation) }}</p>
                            <p class="text-gray-100 fs-14 mb-0">{{ ucwords($vcard->job_title) }}</p>
                            <div class="fs-14 text-gray-100 mb-3 text-center pt-2">
                                {!! $vcard->description !!}
                            </div>
                        </div>
                        {{-- social-media --}}
                    ...
                    <div class="our-services-section pt-60 px-30">
                        ...
                        <div class="services">
                            @if ($vcard->services_slider_view)
                                <div class="row row-gap-20px services-slider-view">
                                    @foreach ($vcard->services as $service)
                                        <div class="col-sm-6">
                                            <div class="service-card h-100 text-start">
                                                <div class="d-flex align-items-center mb-2 flex-column gap-2">
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    ...
                    <img src="{{ asset ("assets/img/vcard31/vector-2.png") }}" alt="images" class="w-100" />
                    </div>
                        <div class="appointment-bg-img text-end">
                            <img src="{{ asset('assets/img/vcard31/make-appointment-bg.png') }}"
                                alt="appointment-bg" />
                        </div>
                        <div class="section-heading">
                        ...
                        <div class="appointment">
                            <div class="row justify-content-center">
                                <div class="col-12">
                                   <div class="row">
                                    <div class="mb-20 col-sm-9 mx-auto">
                                    ...
                                    <div class="mt-2 text-center">
                                        <button class="appointmentAdd btn btn-primary w-100 rounded-2 position-relative d-none">
                                        ...
                                        <div class="card-body p-0 pt-5">
                                            <div class="text-center">
                                                ...
                                                <div class="quote-img text-center mb-3">
                                                    <img src="{{ asset('assets/img/vcard31/quote-img.png') }}"
                                                        class="mx-auto" />
                                                </div>
                                                <p
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-60 mb-3 position-relative">
                        <div class="position-absolute vector-all vector-3 text-end">
                    <img src="{{ asset ("assets/img/vcard31/vector-3.png") }}" alt="images" class="w-100" />
                    </div>
                                ...
                                <div class="row justify-content-center">
                                    @foreach ($businessDaysTime as $key => $dayTime)
                                        <div class="col-sm-6 col-10 mb-3">
                                            <div class="hour">
                                                <div class="text-black">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                                    :</div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-30">
                    ...
                    <div class="qr-code-main-box" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <div class="qr-profile-img mb-3">
                                <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover"
                                    loading="lazy" />
                            </div>
                           <div class="bg-light p-3 qr-box mx-auto">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section pt-40 pb-40 mb-3 position-relative">
                        <div class="position-absolute vector-all vector-4 text-end">
                    <img src="{{ asset ("assets/img/vcard31/vector-4.png") }}" alt="images" class="w-100" />
                    </div>
                    <div class="position-absolute vector-all vector-5 text-end">
                    <img src="{{ asset ("assets/img/vcard31/vector-5.png") }}" alt="images" class="w-100" />
                    </div>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section">
                    ...
                    <div class="add-to-contact-bg-img">
                        <img src="{{ asset('assets/img/vcard31/add-to-contact-bg.png') }}"
