  ...
  <div class="vcardthirty-effect position-reltive w-100 h-100">
    ...
    <div class="container p-0">
        ...
        <div
            ...
            {{-- profile section --}}
            <div class="profile-section pt-50 pb-60 px-30 position-relative" @if (getLanguage($vcard->default_language)
                == 'Arabic') dir="rtl" @endif>
                <div class="card d-flex flex-sm-row gap-4">
                    ...
                    <div class="card-body pt-sm-3 p-0 text-sm-start text-center">
                        <div class="profile-name">
                            <h2 class="text-white mb-0 fs-28">
                            ...
                            <p class="fs-14 text-white mb-0 ">{{ ucwords($vcard->occupation) }}</p>
                            <p class="fs-14 text-white mb-0 ">{{ ucwords($vcard->job_title) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                <div class="profile-desc mb-0 fs-14 text-center pt-50 px-30">
                    {!! $vcard->description !!}
                </div>
                {{-- social-media --}}
                @if (checkFeature('social_links') && getSocialLink($vcard))
                <div class="social-media-section pt-30 position-relative px-30" @if (getLanguage($vcard->default_language) ==
                    'Arabic') dir="rtl" @endif>
                ...
                <div class="custom-link-section">
                    ...
                    <div class="custom-link d-flex flex-wrap justify-content-center pt-30 px-30 w-100">
            ...
            <div class="pt-50 position-relative">
                ...
                <div class="contact-section pt-60 pb-60 px-30">
                    <div class="section-heading mb-5 text-center text-white">
                        <h2 class="mb-0 fw-6">Contacts</h2>
                    </div>
                            ...
                            <div class="card-wrapper">
                                <div class="service-card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p
                                            class="mb-0 text-gray-100 text-center description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                        ...
                        <div class="row row-gap-20px">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="service-card h-100 d-flex flex-column">
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title fw-6 text-white mb-10 text-center">
                                            {{ ucwords($service->name) }}
                                        </h3>
                                        <p
                                            class="mb-0 text-center description-text text-gray-100 {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                            {!! \Illuminate\Support\Str::limit($service->description, 170, '...') !!}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="product-desc card-body">
                                        <div
                                            ...
                                            <h3 class="text-white text-center fw-5 mb-0 product-title">{{
                                                $product->name }}</h3>
                                            <p
                                                class="amount mb-0 fw-6 text-white text-decoration-underline text-center product-amount">
            ...
            <div class="pt-50 position-relative">
                ...
                <div class="testimonial-section pt-60 pb-60 px-20 position-relative">
                    <div class="section-heading mb-5 text-center">
                        <h2 class="mb-0 fw-6 text-white">{{ __('messages.plan.testimonials') }}</h2>
                    </div>
                        ...
                        <div class="card-wrapper">
                            <div class="blog-card card" @if (getLanguage($vcard->default_language) == 'Arabic')
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-gray blog-desc fw-5 mb-0">
                                    ...
                                    <div class="mt-1 d-flex align-items-center justify-content-end">
                                        <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"
                                            class="d-inline-flex align-items-center justify-content-end gap-2 fs-14 read-more">
                        ...
                        <form action="" id="enquiryForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <button class="btn btn-gradient w-100 send-btn" type="submit" {{$subscriptionclass}}>
                                        <div class="wave"></div>
