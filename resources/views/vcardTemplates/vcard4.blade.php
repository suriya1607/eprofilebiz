        ...
        <div
                        ...
                        <form id="enquiryForm" enctype="multipart/form-data">
                            ...
                            @if (getLanguage($vcard->default_language) != 'Arabic')
                                <div class="contact-form px-sm-5">
                                    ...
                                    @endif
                                    <button type="submit"
                                        class="contact-btn text-white mt-4  d-block mx-auto" {{$subscriptionclass}}>{{ __('messages.contact_us.send_message') }}
                                    </button>
                                </div>
                            @endif
                            @if (getLanguage($vcard->default_language) == 'Arabic')
            ...
            <div class="w-100 d-flex justify-content-center  position-fixed" style="top:50%; left:0; z-index: 9999;">
                <div
                    ...
                    <div class="w-100 d-flex justify-content-center sticky-vcard-div sticky-vcard4-div" @if($subscriptionclass == 'disabled') style="pointer-events:none;opacity:0.5;"@endif>
