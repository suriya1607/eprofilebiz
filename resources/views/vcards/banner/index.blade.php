                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="col-12 mt-5">
                                {{ Form::checkbox('banner', 1, (isset($managesection) && $managesection['banner']) || empty($managesection), ['class' => 'form-check-input', 'id' => 'bannerCheckbox']) }}
                                {{ Form::label('bannerCheckbox', __('messages.front_cms.show_banner'), ['class' => 'form-label mb-0 me-2 ms-4']) }}
                            </div>
                        </div>
                    </div>
