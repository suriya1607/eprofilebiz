        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
            <div class="banner-section position-relative">
                <div class="banner-img">
                    <img src="{{ asset('assets/img/vcard19/banner-img.png') }}" class="w-100 h-100 object-fit-cover"
                        loading="lazy" />
                </div>
            ...
            <div class="profile-section px-40">
                ...
                <div class="card d-flex flex-sm-row align-items-sm-end align-items-center">
                    <div class="card-img me-sm-4">
                        <img src="{{ asset('assets/img/vcard19/profile-img.png') }}"
            ...
            <div class="contact-section pb-60">
                <div class="px-3 mx-1">
                    <div class="row">
                                    ...
                                    <svg width="30" height="26" viewBox="0 0 30 26" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_55_141)">
                                            ...
                                            <path
                                                ...
                                                fill="#753422" />
                                            <path d="M15.0189 0C15.3213 0.55239 15.6741 1.18011
                        ...
                        2.37277C14.1243 1.54418 14.5905 0.740705 15.0189 0Z" fill="#753422" />
                                        </g>
                                        <defs>
                ...
                <div class="">
                    <div class="product-slider">
                        <div class="">
                            <div class="product-card card">
                                <div class="product-img card-img">
                                    <img src="{{ asset('assets/img/vcard19/product-img1.png') }}"
                                        class="w-100 h-100 object-fit-cover" loading="lazy" />
                                </div>
                                <div class="product-desc card-body pt-2">
                                    ...
                                    <a href="#!" class="product-amount text-center fs-20 fw-5 py-1">
                                        $1250
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="">
                            <div class="product-card card">
                                <div class="product-img card-img">
                                    <img src="{{ asset('assets/img/vcard19/product-img2.png') }}"
                                        class="w-100 h-100 object-fit-cover" loading="lazy" />
                                </div>
                                <div class="product-desc card-body pt-2">
                        ...
                        <div class="col-sm-6 mb-sm-0 mb-40 mt-4">
                            <div class="service-card h-100">
                                <div class="card-img mx-auto d-flex justify-content-center align-items-center">
                                    <img src="{{ asset('assets/img/vcard19/services-img.png') }}"
                                        class="w-100 h-100 object-fit-cover" loading="lazy" />
                                </div>
            ...
            <div class="appointment-section pt-60 px-40">
                ...
                <div class="appointment px-2">
                    <div class="mb-20">
                        <label for="date" class="appoint-date text-black fs-6 fw-5 mb-1">Date:</label>
                        <div class="row">
                            <div class="col-12 px-2">
                                <div class="position-relative">
                                    <input type="text" class="form-control appointment-input" placeholder="" />
                        ...
                        <div class="blog-card card">
                            <div class="card-img">
                                <div class="img-border">
                                    <div class="mask">
                                        <img src="{{ asset('assets/img/vcard19/blog-img.png') }}"
                                            class="w-100 h-100 object-fit-cover" loading="lazy" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="">
                        <div class="testimonial-card card">
                            <div class="testimonial-profile-img">
                                <img src="{{ asset('assets/img/vcard19/testimonial-img.png') }}"
                                    class="w-100 h-100 object-fit-cover" loading="lazy" />
                            </div>
            ...
            <div class="qr-code-section pt-60 px-40">
                ...
                <div class="qr-code d-flex justify-content-center flex-wrap mb-40">
                    <div class="qr-profile-img">
                        <img src="{{ asset('assets/img/vcard19/qr-profile-img.png') }}"
                            class="w-100 h-100 object-fit-cover" loading="lazy" />
                    </div>
                    <div class="qr-code-img">
                        <img src="{{ asset('assets/img/vcard19/qr-code-img.png') }}"
                            class="w-100 h-100 object-fit-cover" loading="lazy" />
                    </div>
                </div>
                <!-- <div class="px-30">
                    ...
                    <form action="">
                        <div class="row">
                            ...
                            <div class="col-12 mb-40 bg-white">
                                <textarea class="form-control h-100" placeholder="{{ __('messages.form.type_message') }}" rows="3"></textarea>
                            </div>
